...
func ConvertBuildsToCicdTasks(taskCtx plugin.SubTaskContext) (err errors.Error) {
	...
	converter, err := api.NewDataConverter(api.DataConverterArgs{
		...
		Convert: func(inputRow interface{}) ([]interface{}, errors.Error) {
			...
			jenkinsPipeline.Environment = getEnvrionmentValueFromParameters(&jenkinsBuild.Parameters, &jenkinsPipeline.Environment)
			...
			if !jenkinsBuild.HasStages {
				...
				jenkinsTask.Environment = getEnvrionmentValueFromParameters(&jenkinsBuild.Parameters, &jenkinsTask.Environment)
